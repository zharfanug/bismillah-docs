...
Order and defaults revised in Phase 10 (2026-08-15, §33) — Main Announcement inserted right after Cover, A Note From Us moved later (after Gallery instead of right after Couple Profile). Reordered again (2026-08-15): Countdown moved to after Couple Profile — the announcement, then who the couple is, then the countdown to the day.
...
| 3 | Couple profile | **On** | Two full-screen sections, bride then groom (revised — was one combined overlapping layout; split for readability, see §13). |
| 4 | Countdown timer | **On** | Live countdown to the event date/time. |
